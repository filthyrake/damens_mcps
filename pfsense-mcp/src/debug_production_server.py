#!/usr/bin/env python3
"""
Debug Production pfSense MCP Server - To see what's happening.
"""
...
class DebugProductionPfSenseMCPServer:
    """Debug Production MCP server for pfSense."""
...
async def create_my_server():
    ...
    return DebugProductionPfSenseMCPServer()
